...
class __TwigTemplate_7b62e5db8a52fea31a7a7ef965050064 extends Template
{
...
($context["required"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("form-required invalid-feedback") : ("")), "card-header"];
            // line 27
            yield "
    <summary";
            // line 28
