...
class __TwigTemplate_645334de8043ce62abaa2ee5ffb2a5a6 extends Template
{
  ...
  ";
        // line 33
        $context["legend_span_classes"] = ["fieldset-legend", (((($tmp =         // line 35
...
($context["required"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("form-required") : (""))];
  ...
  <div class=\"fieldset-wrapper\">
    ...
    ";
        ...
        // line 56
        yield "    ";
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["description"] ?? null), "content", [], "any", false, false, true, 56)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 57
            yield "      <div";
