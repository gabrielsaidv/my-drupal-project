...
class __TwigTemplate_d698b8fdb15b0323dc8c4d96d2853521 extends Template
{
    ...
    <div";
      ...
      ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["theme"]) {
                ...
                yield "        ";
                // line 45
                $context["theme_classes"] = [(((($tmp = CoreExtension::getAttribute($this->env, $this->source,                 // line 46
$context["theme"], "is_default", [], "any", false, false, true, 46)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("theme-default") : ("")), (((($tmp = CoreExtension::getAttribute($this->env, $this->source,                 // line 47
$context["theme"], "is_admin", [], "any", false, false, true, 47)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("theme-admin") : ("")), (((CoreExtension::getAttribute($this->env, $this->source,                 // line 48
$context["theme_group"], "state", [], "any", false, false, true, 48) == "installed")) ? ("col-12 col-md-3") : ("col-12 col-md-2"))];
        ...
        <div class=\"card h-100\">
          ";
                // line 53
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["theme"], "screenshot", [], "any", false, false, true, 53)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 54
...
";
    ...
    {
        return new Source("", "themes/contrib/bootstrap5/templates/admin/system-themes-page.html.twig", "/var/www/html/web/themes/contrib/bootstrap5/templates/admin/system-themes-page.html.twig");
    }
