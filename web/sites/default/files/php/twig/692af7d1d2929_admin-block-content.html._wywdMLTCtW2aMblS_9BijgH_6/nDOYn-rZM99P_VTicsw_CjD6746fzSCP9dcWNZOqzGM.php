...
class __TwigTemplate_49d119e7f8dbbe9302918dbdc1abcc9c extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 20
        $context["classes"] = ["list-group", (((($tmp =         // line 22
($context["compact"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("compact") : (""))];
    ...
    ";
      ...
      ";
                // line 29
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["item"], "description", [], "any", false, false, true, 29)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    // line 30
